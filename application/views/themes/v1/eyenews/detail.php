...
<div id="reqdetail" class='loaddetail' action="eyenews" loading="off" clean="clsdetail">
    <div id='clsdetail'>
        <script>
...
<div class="container-comment">
    <span class="up-next-etube" style="padding-left: 10px !important;color: #212121 !important;">Komentar</span> <span id="close" class="up-next-etube"
                                                                                                                       style="float:right; padding-right: 10px;"><i
